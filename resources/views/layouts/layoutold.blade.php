...
<head>
    ...
    <!-- stylesheet -->
    <link rel="stylesheet" href="{{ asset('cssfile/layout/layoutold.css') }}">
        ...
        <div class="layout-navbar">
            ...
            <nav>
                <ul id="menuList">
                    ...
                    @auth
                        <li><a href="{{ route('index') }}">Profile</a></li>
                    @endauth
                </ul>
            </nav>
            <ul class="profile-navbar">
                ...
                @else
                    <li class="nav-item-user">
                        ...
                        <ul class="nav-logout-dropdown" aria-labelledby="navbarDropdown">
